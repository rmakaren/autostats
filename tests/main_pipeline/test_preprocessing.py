...
class TestPreprocessing:
    ...
    def test_preprocessing(self, 
        ...
        df_preproc = preprocess.preprocessing(dataset = dataset_NaN,
                                        labels = "labels")
        ...
        with pytest.raises(
            ...
            NaN_all = preprocess.preprocessing(dataset = dataset_NaN_all, labels = "labels")

        # 3. no NaN, should do nothing
        dataset_no_NaN = generate_df_NaN(num_rows=100, num_cols=10, num_missing=0)
        df_preproc3 = preprocess.preprocessing(dataset = dataset_no_NaN,
                                        labels = "labels") 
        ...
        df_preproc4 = preprocess.preprocessing(dataset = dataset_no_dupl,
                                        labels = "labels")
        ...
        df_preproc5 = preprocess.preprocessing(dataset = dataset_dupl,
                                        labels = "labels")
        ...
        df_preproc6 = preprocess.preprocessing(dataset = dataset_dupl1,
                                        labels = "labels")
        ...
        df_preproc7 = preprocess.preprocessing(dataset = dataset_dupl_all,
                                        labels = "labels")
        ...
        df_preproc8 = preprocess.preprocessing(dataset = dataset_inf,
                                        labels = "labels")
        ...
        # ):
        #     df_one_row = preprocess.preprocessing(dataset = dataset_1row, labels = "labels")
        ...
        with pytest.raises(
            ...
            df_one_label = preprocess.preprocessing(dataset = dataset_1_label, labels = "labels") 
        ...
        with pytest.raises(
            ...
            df_one_label = preprocess.preprocessing(dataset = dataset_labels_test1, labels = "labels") 
        ...
        with pytest.raises(
            ...
            df_one_label = preprocess.preprocessing(dataset = dataset_labels_test2, labels = "labels") 

        # 11. Dependent variable is integer
        dataset_labels_test3 = generate_df_labels_test(num_rows=100, num_cols=10, labels=[0, 1, 2])
        df_label_int = preprocess.preprocessing(dataset = dataset_labels_test3, labels = "labels")
        ...
        df_label_str = preprocess.preprocessing(dataset = dataset_labels_test4, labels = "labels")
